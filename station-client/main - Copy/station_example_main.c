...
#define HOST_IP_ADDR "192.168.72.119"
#define PORT 6666
...
void vTaskClient(void * pvParameters)
{
    while (1)
    {
        ...
        ESP_LOGI(TAG_CLI, "Socket created, connecting to %s:%d", HOST_IP_ADDR, PORT);
        ...
        while (1)
        {
            xTaskNotifyWait(0xffffffff, 0x0, &sensor_data, pdMS_TO_TICKS(1000));
